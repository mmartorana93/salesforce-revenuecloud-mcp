...
ACTION_REGISTRY = {
    ...
    "cancelApprovalSubmission": {
        ...
        "since": "66.0",
        "description": "Cancel an approval submission.",
    ...
    "recallApprovalSubmission": {
        ...
        "since": "66.0",
        "description": "Recall a submitted approval.",
        "required": ["approvalSubmissionId"],
        "optional": ["comments"],
        "properties": {"approvalSubmissionId": {"type": "string"}, "comments": {"type": "string"}},
    },
    "reviewApprovalWorkItem": {
        ...
        "since": "66.0",
        "description": "Approve or reject an approval work item.",
    ...
    "overrideApprovalWorkItem": {
        ...
        "since": "66.0",
        "description": "Override an approval decision on a work item.",
        "required": ["approvalWorkItemId", "approvalDecision"],
        "optional": ["comments", "channelType"],
        "properties": {
            "approvalWorkItemId": {"type": "string"},
    ...
    "reassignApprovalWorkItem": {
        ...
        "since": "66.0",
        "description": "Reassign an approval work item to a different user or queue.",
